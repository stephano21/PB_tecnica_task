...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tasks.Entities.CustomUserIdentity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Tasks.Entities.Profile", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Tasks.Entities.TaskNotes", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tasks.Entities.CustomUserIdentity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tasks.Entities.Profile", b =>
                {
                    b.HasOne("Tasks.Entities.CustomUserIdentity", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Tasks.Entities.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tasks.Entities.TaskNotes", b =>
                {
                    b.HasOne("Tasks.Entities.Profile", "Profile")
                        .WithMany("Tasks")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
